...
public class Menu {
    //Esta clase representa el controlador de la vista, es decir, el menu principal de la aplicación
    //Debe contener todos los métodos necesarios para manejar la informacion requerida por las especificaciones de la aplicacion.

    Scanner scanner = new Scanner(System.in);
     EmpleadoRepository empleadoRepo = new EmpleadoRepository();
     OficinaRepository oficinaRepo = new OficinaRepository();
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case "4":
                    ...
                    oficinaActualizar.setCiudad(newData.isEmpty() ? oficinaActualizar.getCiudad() : newData);
    ...
    public void validateOficina(Empleado nuevo) {
